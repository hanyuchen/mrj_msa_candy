...
**4 Sample Queries and Results, and Sample forms**

<table>
  <tr>
    <td></td>
    <td>#1 Ask database whether the email and password match</td>
  </tr>
  <tr>
    <td>SQL</td>
    <td></td>
...
<table>
  <tr>
    <td></td>
    <td>#2 Given box_id, return box information</td>
  </tr>
  <tr>
    <td>SQL</td>
    <td></td>
...
<table>
  <tr>
    <td></td>
    <td>#3 Given email, return user’s all orders</td>
  </tr>
  <tr>
    <td>SQL</td>
    <td></td>
...
<table>
  <tr>
    <td></td>
    <td>#1 Calculate the average box sales based on different cities in CA
We could figure out which cities has the highest average sales and establish different sales strategy based on the result. As the result below, we could know that total average sales at Berkeley is the highest one. </td>
  </tr>
  <tr>
    <td>SQL</td>
    <td></td>
...
<table>
  <tr>
    <td></td>
    <td>#2 Who is loyal customer
We could sum up total sales based on customer ID,  and figure out the person who buys the most is the loyal customer. Also, we could calculate the average of total sales to set the threshold where customers could be promoted as VIP.</td>
  </tr>
  <tr>
    <td>SQL</td>
    <td></td>
  ...
  <tr>
    <td>Query Result</td>
    <td>"first_name" "last_name" "SUM(total_price)"
"Jeff"	"Yu"	"1946.5"
"Sam"	"Smith"	"132.5"
"Mike"	"Song"	"100.0"</td>
  </tr>
